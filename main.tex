...
can be used to overcome the frequency-dependent beam effects and
accurately separate the EoR signal, which exhibits the great potential
of deep-learning-based methods in future EoR experiments.
\end{abstract}
...
filters by minimising the loss $L$,
...
beam effects and accurately separate the EoR signal,

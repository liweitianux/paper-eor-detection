...
emission, which includes the Galactic synchrotron and free-free
...
(1) The frequency resolution is improved to \SI{80}{\kHz} to better
...
51 complex Fourier coefficients, among which the 6 coefficients of
the lowest Fourier frequencies ($n_{\R{ex}}$) is excised.
